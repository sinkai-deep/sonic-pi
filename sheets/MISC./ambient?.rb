...
with_fx :reverb, room: 0.1 do
  live_loop :bass, sync: :metro do
    ...
    n1 = [2,5,0,1 ,3,5,7,0 ,2,5,0,1 ,7,1,0,1].tick(:note)
...
live_loop :ambi, sync: :metro do
  ##| stop
  use_bpm get[:bpm]
  notes = chord(:a2, 'minor')
  a = range(0.1, 1, step: 0.01).mirror.tick(:amp)
